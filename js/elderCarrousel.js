(function () {
    ...
    function move(self) {
      ...
      self.track.style.transform = `translate3d(${self.trackPosition}px,6rem,0)`
    ...
    function createNavs(self) {
      ...
      prevNav = self.settings.prevNav || document.createElement('ion-icon')
      prevNav.className = 'ec__nav ec__nav--prev'
      prevNav.setAttribute('name', 'chevron-back-outline')
      ...
      nextNav = self.settings.nextNav || document.createElement('ion-icon')
      nextNav.className = 'ec__nav ec__nav--next'
      nextNav.setAttribute('name', 'chevron-forward-outline')
